...
\begin{tikzpicture}[x=1mm, y=1mm]
    ...
    \textbf{Fighting Style:} You have honed your martial prowess and gain a Fighting style feat of your choice (Interception).\\[0.5em]\textbf{Interception:} When a creature you can see hits another creature within 5 feet of you with an attack roll, you can take a Reaction to reduce the damage dealt to the target by 1d10 plus your Proficiency Bonus. You must beh olding a Shield or a Simple or Martial weapon to use this Reaction.\\[0.5em]
